...
export const shadows = {
  ...
  premiumLg: '0 20px 60px rgba(0, 0, 0, 0.15), 0 4px 16px rgba(0, 0, 0, 0.08)',
  innerPremium: 'inset 0 2px 8px rgba(0, 0, 0, 0.06)',
  glowPrimary: '0 0 20px rgba(99, 102, 241, 0.4)',
  glowSecondary: '0 0 20px rgba(217, 70, 239, 0.4)',
  none: 'none',
} as const
